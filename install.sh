...
say_step "4/6 Slash commands (/voice-on, /voice-off, /voice-phone, /voice-help, ...)"
...
# Retired names: /phone became /voice-phone; remove the stale entry
rm -f "$CLAUDE_DIR/commands/phone.md" "$CLAUDE_DIR/commands/vb-phone.md" "$CLAUDE_DIR/commands/voice-stop.md"
